...
def test_stale_badsha_fixture_fails_with_malformed_sha() -> None:
    # Reproduces #19's exact reported bug shape: Hamma marked `done` (prose)
    # while only telemetry had moved. Here the SHA cell holds "done" instead
    # of a hex SHA — same defect class, mechanically detected.
